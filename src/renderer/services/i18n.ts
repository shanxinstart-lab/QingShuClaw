...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    aboutBrandEyebrow: '灵工打卡 · 数据智能体',
    aboutBrandDescription: 'QingShuClaw 搭载于青数中台之上，是一款可在用户权限范围内访问与分析灵工打卡数据的内部数据产品。',
    aboutProductBadge: '内部数据产品',
    aboutPlatformBadge: '青数中台',
    aboutProductType: '产品定位',
    aboutProductTypeValue: '灵工打卡数据智能体',
    aboutPlatform: '搭载平台',
    aboutPlatformValue: '青数中台',
    aboutDataScope: '数据范围',
    aboutDataScopeValue: '仅访问当前用户权限范围内的灵工打卡数据',
    aboutRightsReserved: 'All rights reserved.',
    aboutCopyright: 'Copyright © {year} QingShuClaw',
    testMode: '测试模式',
    theme: '主题',
    appearance: '外观',
    language: '语言',
    ...
    providerMissingApiKey: '缺少密钥',
    providerModelCountUnit: '个模型',
    ...
    authLoginWelcomeSubtitle: '灵工打卡',
    authEnterUsernameAndPassword: '请输入用户名和密码',
    authSettingsTitle: '登录认证',
    authSettingsDescription: '当前项目默认使用青数认证，可按需调整后端地址',
    authBackendQtb: '青数认证（账密 + 飞书）',
    authQtbApiBaseUrl: '青数 API 地址',
    authQtbApiBaseUrlPlaceholder: '例如：http://localhost:9080',
    authQtbWebBaseUrl: '青数 Web 地址',
    authQtbWebBaseUrlPlaceholder: '例如：http://localhost:9080/webapp',
    productBrandSignature: '灵工打卡 青数',
    authQuotaExhausted: '今日免费额度已用完。您可以登录 QingShuClaw Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: 'QingShuClaw 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 QingShuClaw 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 QingShuClaw 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'QingShuClaw 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkConfigSaveFailed: '保存 QingShuClaw 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'QingShuClaw 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'QingShuClaw 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkDescription: '立足灵工场景，懂业务、会分析、能执行的数据智能体',
    ...
    coworkSpeechTranscribing: '正在转写语音...',
    speechInputCommandsTitle: '语音输入触发词',
    speechInputCommandsDescription: '配置 macOS 本地语音输入在聊天框中用于停止输入或直接发送的尾部触发词。',
    speechInputLlmCorrectionLabel: 'STT 结果使用当前模型修正',
    speechInputStopCommandLabel: '停止输入触发词',
    speechInputStopCommandPlaceholder: '例如：停止',
    ...
    coworkSpeechInterrupted: '语音识别被系统中断，请稍后重试。',
    coworkSpeechNoMatch: '没有识别到可转写的语音内容。',
    wakeInputTitle: '语音唤醒输入',
    wakeInputDescription: '仅 macOS 本地支持。应用后台待机时监听唤醒词，唤醒后自动聚焦聊天框并开始听写。',
    wakeInputEnabledLabel: '启用语音唤醒',
    wakeInputWakeWordLabel: '固定唤醒词',
    wakeInputWakeWordsLabel: '唤醒词列表',
    wakeInputWakeWordsPlaceholder: '每行一个，例如：\n打开青书爪\n初一',
    wakeInputProviderLabel: '唤醒引擎',
    wakeInputProvider_text_match: 'macOS 原生唤醒',
    wakeInputProvider_sherpa_onnx: 'Sherpa 唤醒',
    wakeInputProviderHint: '默认使用 macOS 原生唤醒；如你更习惯本地模型唤醒，可切换到 Sherpa。',
    wakeInputSherpaModelLabel: 'Sherpa 唤醒模型',
    wakeInputSherpaModelHint: 'Sherpa 唤醒默认使用双语 `zh-en` 模型，也可以切换回旧的中文 `WenetSpeech` 模型。',
    ...
    wakeInputActivationReplyTextPlaceholder: '例如：在的',
    ...
    ttsTitle: '本地语音朗读',
    ttsDescription: '仅 macOS 本地支持。使用 macOS 本地语音合成朗读助手回复，不需要云端服务。',
    ttsEnabledLabel: '启用本地 TTS',
    ttsAutoPlayLabel: '自动朗读助手回复',
    ttsLlmRewriteLabel: '朗读前使用当前模型改写口播稿',
    ttsSkipKeywordsLabel: '跳过内容关键词',
    ttsSkipKeywordsPlaceholder: '每行一个，例如：\n/\n思考中\n工具调用',
    ttsSkipKeywordsHint: '按关键词删除不适合口播的片段。默认静态清洗仍会自动移除 emoji、孤立斜杠和 Markdown 杂质。',
    ttsEngineLabel: 'TTS 引擎',
    ttsEngine_macos_native: 'macOS 本地',
    ttsEngine_edge_tts: 'edge-tts',
    ttsEngine_sherpa_onnx: 'Sherpa-ONNX',
    ttsPrepareStatusLabel: '运行时状态',
    ttsPrepareStatus_idle: '未安装',
    ttsPrepareStatus_installing: '安装中',
    ttsPrepareStatus_ready: '可用',
    ttsPrepareStatus_error: '失败',
    ttsPrepareLastErrorLabel: '最近错误',
    ttsActualEngineLabel: '最近实际播放引擎',
    ttsActualEngineNone: '暂无播放记录',
    ttsActualEngineFallbackLabel: '已从已选引擎自动回退',
    ttsPrepareRetryButton: '重新安装 / 重试',
    ttsVoiceLabel: '默认 voice',
    ttsVoiceAuto: '自动选择系统 voice',
    ttsRateLabel: '语速',
    ttsVolumeLabel: '音量',
    ttsVoiceHint: '高质量 voice 需要先在 macOS 系统设置中下载；若当前 voice 不可用，将自动回退到系统默认 voice。',
    voiceSettingsTitle: '统一语音能力',
    voiceSettingsDescription: '统一管理手动语音输入、语音唤醒、自动续麦和本地语音朗读。当前已接入 macOS 原生链路、Sherpa-ONNX 本地 STT/TTS，以及对应的能力矩阵和回退状态展示。',
    desktopAssistantTitle: '桌面助手（实验）',
    desktopAssistantDescription: '桌面助手能力以旁路附加方式接入，默认关闭，不会改变现有语音主链路的默认行为。',
    desktopAssistantMasterEnabled: '启用桌面助手实验能力',
    desktopAssistantLaunchAtLogin: '桌面助手开机后可用',
    desktopAssistantAutoOpenPreviewGuide: '自动打开可预览结果',
    desktopAssistantAutoEnterSceneGuide: '自动进入讲解会话',
    desktopAssistantGuideVoiceCommandsEnabled: '启用讲解语音命令',
    desktopAssistantAssistantReplySpeakMode: '助手讲解播报模式',
    desktopAssistantAssistantReplySpeakMode_summary: '摘要播报',
    desktopAssistantAssistantReplySpeakMode_detailed: '详细讲解',
    desktopAssistantExperimentalHint: '这些开关当前只保存配置，不会改写现有手动 STT、唤醒词、自动续麦和 TTS 行为。',
    desktopAssistantGuideSessionActive: '讲解中',
    desktopAssistantGuideSessionIdle: '未激活',
    desktopAssistantGuideReadyLabel: '桌面助手演示',
    desktopAssistantInlineGuideHint: '当前回复包含可演示 HTML，开始讲解时会自动保存为本地演示文件。',
    desktopAssistantPreviewGuideHint: '当前回复包含可讲解的预览结果，可以直接开始讲解。',
    desktopAssistantLocalPreviewLabel: '演示文件',
    desktopAssistantOpenLocalPreview: '打开本地演示文件',
    desktopAssistantLinkedPreviewLabel: '联动预览',
    desktopAssistantPauseGuide: '暂停',
    desktopAssistantResumeGuide: '继续',
    desktopAssistantPreviousScene: '上一步',
    desktopAssistantNextScene: '下一步',
    desktopAssistantReplayScene: '重讲本幕',
    desktopAssistantStopGuide: '停止',
    desktopAssistantGuideDockTitle: '讲解中控',
    desktopAssistantGuideProgress: '第 {current} / {total} 幕',
    desktopAssistantStartGuide: '开始讲解',
    desktopAssistantAutoSkillHint: '当前请求将自动附加技能：{skill}',
    desktopAssistantAutoSkillBadge: '自动',
    desktopAssistantGuideSourceNotFound: '未找到最近可演示的 HTML / 页面结果。',
    desktopAssistantState_idle: '空闲',
    desktopAssistantState_wake_listening: '后台监听中',
    desktopAssistantState_dictating: '听写中',
    desktopAssistantState_assistant_replying: '助手回复中',
    desktopAssistantState_assistant_speaking: '助手播报中',
    desktopAssistantState_guide_active: '讲解会话进行中',
    desktopAssistantState_paused: '讲解已暂停',
    desktopAssistantState_error: '状态异常',
    voiceCapabilityManualSttTitle: '手动语音输入',
    voiceManualSttDescription: '控制聊天框麦克风按钮是否可用。',
    voiceCapabilityWakeInputTitle: '语音唤醒',
    voiceCapabilityFollowUpTitle: '自动续麦',
    followUpDictationDescription: '开启后，对当前活跃会话生效。回复完成后会自动重新进入语音输入，不要求上一轮必须来自语音输入。',
    voiceCapabilityTtsTitle: '语音朗读',
    voiceProviderStatusTitle: 'Provider 状态',
    voiceProviderStatusDescription: '平台支持、当前安装包是否包含 provider，以及当前配置是否可用，都以这里的能力矩阵为准。',
    voiceShowAllStatuses: '查看全部状态',
    voiceShowInUseStatuses: '仅看使用中',
    voiceRoutingTitle: 'Provider 路由',
    voiceRoutingDescription: '为手动语音输入和语音朗读选择 provider，并定义当首选 provider 不可用时的回退策略。',
    voiceStrategyLabel: '回退策略',
    voiceStrategy_manual: '仅使用选中 provider',
    voiceStrategy_native_first: '本地优先',
    voiceStrategy_cloud_first: '云端优先',
    voiceManualSttProviderLabel: '手动语音输入 provider',
    voiceTtsProviderLabel: '语音朗读 provider',
    voiceFollowUpProviderHint: '自动续麦会跟随手动语音输入的 provider 解析结果，不单独配置。当前包若未包含云 provider，能力矩阵会明确显示不可用原因。',
    voiceCloudProviderConfigTitle: '语音 Provider 配置',
    voiceCloudProviderConfigDescription: '这里统一维护本地与云端语音 provider 的接入参数。当前已接入 OpenAI、阿里云、火山引擎的 STT/TTS，以及 Azure TTS；本地 `whisper.cpp` 已接入最小可用执行链路，并补充了本地资源治理入口。',
    voiceProviderWorkspaceTitle: '语音 Provider 工作台',
    voiceProviderWorkspaceDescription: '左侧只保留 provider 摘要，右侧只编辑当前选中的 provider，避免一次展开所有接入参数。',
    voiceProviderWorkspaceExpand: '展开工作台',
    voiceProviderWorkspaceCollapse: '收起工作台',
    voiceProviderWorkspaceSelectedLabel: '当前编辑',
    voiceProviderWorkspaceRoutesLabel: '关联能力',
    voiceProviderWorkspaceInUseCountLabel: '使用中',
    voiceProviderWorkspaceInUseCountValue: '{count} 个 Provider',
    voiceProviderConfigured: '已配置',
    voiceProviderNotConfigured: '未配置',
    voiceProviderInUse: '使用中',
    voiceProviderSelectHint: '从左侧选择一个 provider 查看或调整接入参数。',
    voiceProviderLinkedCapabilitiesLabel: '关联能力',
    voiceProviderManagedInTtsHint: '该 provider 的 voice、语速和音量由上方 TTS 能力统一管理。',
    voiceOverviewRequestedProvider: '请求 provider',
    voiceOverviewActualProvider: '实际 provider',
    voiceOverviewFallbackStatus: '回退状态',
    voiceOverviewFallbackReason: '回退原因',
    voiceFallbackActive: '已回退',
    voiceFallbackInactive: '未回退',
    voiceLocalWhisperCppDescription: '用于本地 `whisper.cpp` STT provider。当前已支持手动语音输入、自动续麦、能力矩阵判定、打包区分，以及本地资源目录排查。',
    voiceLocalSherpaOnnxDescription: '用于本地 `Sherpa-ONNX` STT provider。适合中文离线实时听写，并可在 macOS 上回退到原生听写链路。',
    voiceLocalQwen3TtsDescription: '用于本地 `Qwen3-TTS` provider。当前支持按需下载模型、检测 Python 运行时，并接入实验性的本地合成执行链路。',
    voiceCloudOpenAiDescription: '用于 OpenAI 云端语音能力接入。当前已接入手动 STT、自动续麦 STT 与 TTS。',
    voiceCloudAliyunDescription: '用于阿里云 DashScope / Model Studio 语音能力接入。当前已接入手动 STT、自动续麦 STT 与 TTS。',
    voiceCloudVolcengineDescription: '用于火山引擎音频技术 / 豆包语音接入。当前已接入手动 STT、自动续麦 STT 与 TTS。',
    voiceCloudAzureDescription: '用于 Azure Speech TTS 的接入配置。当前已接入 TTS，STT 后续可继续扩展。',
    voiceCloudCustomDescription: '预留自定义云端 STT/TTS 接口的接入参数。',
    voiceProviderApiKeyLabel: 'API Key',
    voiceProviderBaseUrlLabel: 'Base URL',
    voiceProviderBinaryPathLabel: 'Binary Path',
    voiceProviderModelPathLabel: 'Model Path',
    voiceProviderTokenizerPathLabel: 'Tokenizer Path',
    voiceProviderPythonCommandLabel: 'Python Command',
    voiceProviderModelIdLabel: 'Model ID',
    voiceProviderModelNameLabel: 'Model Name',
    voiceProviderSttModelLabel: 'STT 模型',
    voiceProviderTtsModelLabel: 'TTS 模型',
    voiceProviderTtsVoiceLabel: 'TTS Voice',
    voiceProviderSherpaAsrModelIdLabel: 'Sherpa ASR 模型 ID',
    voiceProviderSherpaTtsModelIdLabel: 'Sherpa TTS 模型 ID',
    voiceProviderSherpaAsrModelPathLabel: 'Sherpa ASR 模型路径',
    voiceProviderSherpaTtsModelPathLabel: 'Sherpa TTS 模型路径',
    voiceProviderSherpaProviderLabel: 'Sherpa Runtime Provider',
    voiceProviderSherpaSampleRateLabel: 'Sherpa 采样率',
    voiceSherpaWakeModelLabel: 'Sherpa 唤醒模型',
    voiceSherpaResourceRootLabel: 'Sherpa 资源目录',
    voiceSherpaAsrReadyLabel: 'Sherpa ASR 已就绪',
    voiceSherpaWakeReadyLabel: 'Sherpa 唤醒已就绪',
    voiceSherpaTtsReadyLabel: 'Sherpa TTS 已就绪',
    voiceSherpaResolvedAsrModelLabel: 'Sherpa ASR 模型路径',
    voiceSherpaResolvedTtsModelLabel: 'Sherpa TTS 模型路径',
    voiceSherpaWakeResourceRootLabel: 'Sherpa 唤醒资源目录',
    voiceSherpaVoiceCountLabel: 'Sherpa Voice 数量',
    voiceSherpaFallbackPolicyLabel: 'macOS 回退策略',
    sherpaWakeModel_zh_en: 'zh-en-3M-2025-12-20（中英双语）',
    sherpaWakeModel_wenetspeech: 'wenetspeech-3.3M-2024-01-01（中文）',
    voiceSherpaFallbackPolicyMacos: 'Sherpa 优先，失败时自动回退到 macOS 原生。',
    voiceSherpaFallbackPolicyNone: '当前平台无 macOS 原生回退，仅使用 Sherpa。',
    voiceProviderSpeakerLabel: 'Speaker',
    voiceProviderInstructLabel: '风格描述',
    voiceProviderDeviceLabel: 'Device',
    voiceProviderLocalTaskLabel: '本地任务模式',
    voiceProviderLocaleLabel: 'Locale',
    voiceProviderThreadsLabel: '线程数',
    voiceProviderUseGpuLabel: '启用 GPU',
    voiceProviderAutoDownloadModelLabel: '自动下载模型',
    voiceLocalWhisperCppEnabledLabel: 'Provider 已启用',
    voiceLocalWhisperCppReadyLabel: '本地资源就绪',
    voiceLocalWhisperCppBinaryExistsLabel: '二进制存在',
    voiceLocalWhisperCppModelExistsLabel: '模型存在',
    voiceLocalWhisperCppResourceRootLabel: '资源根目录',
    voiceLocalWhisperCppBinaryDirectoryLabel: '二进制目录',
    voiceLocalWhisperCppModelsDirectoryLabel: '模型目录',
    voiceLocalWhisperCppExpectedBinaryLabel: '默认二进制路径',
    voiceLocalWhisperCppExpectedModelLabel: '默认模型路径',
    voiceLocalWhisperCppResolvedBinaryLabel: '解析到的二进制路径',
    voiceLocalWhisperCppResolvedModelLabel: '解析到的模型路径',
    voiceLocalWhisperCppRefreshButton: '刷新状态',
    voiceLocalWhisperCppPrepareButton: '创建资源目录',
    voiceLocalWhisperCppOpenRootButton: '打开资源目录',
    voiceLocalWhisperCppOpenModelsButton: '打开模型目录',
    voiceLocalWhisperCppRefreshSuccess: '本地 whisper.cpp 状态已刷新。',
    voiceLocalWhisperCppPrepareSuccess: '本地 whisper.cpp 资源目录已创建。',
    voiceLocalWhisperCppPrepareFailed: '创建本地 whisper.cpp 资源目录失败。',
    voiceLocalWhisperCppDirectoryUnavailable: '当前无法定位本地 whisper.cpp 目录。',
    voiceLocalQwen3TtsEnabledLabel: 'Provider 已启用',
    voiceLocalQwen3TtsReadyLabel: '本地运行条件就绪',
    voiceLocalQwen3TtsPythonAvailableLabel: 'Python 可用',
    voiceLocalQwen3TtsPythonResolvedPathLabel: '解析到的 Python 路径',
    voiceLocalQwen3TtsPythonVersionLabel: 'Python 版本',
    voiceLocalQwen3TtsModelExistsLabel: '模型存在',
    voiceLocalQwen3TtsTokenizerExistsLabel: 'Tokenizer 存在',
    voiceLocalQwen3TtsQwenModuleLabel: '`qwen_tts` 模块可用',
    voiceLocalQwen3TtsTorchModuleLabel: '`torch` 模块可用',
    voiceLocalQwen3TtsSoundfileModuleLabel: '`soundfile` 模块可用',
    voiceLocalQwen3TtsHuggingfaceCliLabel: '`huggingface-cli` 可用',
    voiceLocalQwen3TtsHuggingfaceHubLabel: '`huggingface_hub` 模块可用',
    voiceLocalQwen3TtsRunnerWritableLabel: '运行目录可写',
    voiceLocalQwen3TtsRuntimeIssuesLabel: '运行时问题',
    voiceLocalQwen3TtsModelsRootLabel: '模型根目录',
    voiceLocalQwen3TtsExpectedModelLabel: '默认模型路径',
    voiceLocalQwen3TtsExpectedTokenizerLabel: '默认 Tokenizer 路径',
    voiceLocalQwen3TtsResolvedModelLabel: '解析到的模型路径',
    voiceLocalQwen3TtsResolvedTokenizerLabel: '解析到的 Tokenizer 路径',
    voiceLocalQwen3TtsRefreshButton: '刷新本地 TTS 状态',
    voiceLocalQwen3TtsOpenRootButton: '打开本地语音目录',
    voiceLocalQwen3TtsOpenModelsButton: '打开 Qwen3-TTS 模型目录',
    voiceLocalQwen3TtsRefreshSuccess: '本地 Qwen3-TTS 状态已刷新。',
    voiceLocalQwen3TtsDirectoryUnavailable: '当前无法定位本地 Qwen3-TTS 目录。',
    voiceLocalQwen3TtsTask_custom_voice: 'Custom Voice',
    voiceLocalQwen3TtsTask_voice_design: 'Voice Design',
    voiceLocalQwen3TtsNoRuntimeIssues: '未发现额外运行时问题',
    voiceLocalModelRecommendedTag: '推荐',
    voiceLocalModelSizeLabel: '模型大小',
    voiceLocalModelInstallBackendLabel: '安装方式',
    voiceLocalModelStatusLabel: '安装状态',
    voiceLocalModelProgressLabel: '下载进度',
    voiceLocalModelLastErrorLabel: '最近错误',
    voiceLocalModelInstallButton: '下载',
    voiceLocalModelReinstallButton: '重新下载',
    voiceLocalModelCancelButton: '取消下载',
    voiceLocalModelOpenPathButton: '打开目录',
    voiceLocalModelUseButton: '设为当前模型',
    voiceLocalModelInUseTag: '当前使用',
    voiceLocalModelRequirementsLabel: '宿主机要求',
    voiceLocalModelWarningsLabel: '重要提示',
    voiceLocalModelInstallConfirmTitle: '开始下载本地语音模型前，请先确认宿主机环境要求。',
    voiceLocalModelInstallFailed: '本地语音模型下载失败。',
    voiceLocalModelOpenPathFailed: '当前无法打开本地语音模型目录。',
    voiceLocalModelBackend_direct: '直接下载',
    voiceLocalModelBackend_direct_archive: '下载并解压',
    voiceLocalModelBackend_huggingface_cli: 'Hugging Face CLI',
    voiceLocalModelBackend_modelscope_cli: 'ModelScope CLI',
    voiceLocalModelState_not_installed: '未安装',
    voiceLocalModelState_downloading: '下载中',
    voiceLocalModelState_installed: '已安装',
    voiceLocalModelState_error: '安装异常',
    voiceProviderVolcengineAppKeyLabel: 'Volcengine AppKey',
    voiceProviderVolcengineTokenLabel: 'Volcengine Token',
    voiceProviderAzureRegionLabel: 'Azure Region',
    voiceProviderAzureEndpointLabel: 'Azure Endpoint',
    voiceProviderCustomSttPathLabel: 'STT Path',
    voiceProviderCustomTtsPathLabel: 'TTS Path',
    voiceCurrentProviderLabel: '当前 provider',
    voicePlatformSupportLabel: '平台支持',
    voicePackagedSupportLabel: '安装包支持',
    voiceRuntimeAvailableLabel: '运行时可用',
    voiceConfiguredLabel: '已完成配置',
    voiceReasonLabel: '状态说明',
    voiceAvailabilityYes: '是',
    voiceAvailabilityNo: '否',
    voiceProvider_none: '未选择',
    voiceProvider_macos_native: 'macOS 原生',
    voiceProvider_local_sherpa_onnx: '本地 Sherpa-ONNX',
    voiceProvider_local_whisper_cpp: '本地 whisper.cpp',
    voiceProvider_local_qwen3_tts: '本地 Qwen3-TTS',
    voiceProvider_cloud_openai: 'OpenAI 云服务',
    voiceProvider_cloud_aliyun: '阿里云',
    voiceProvider_cloud_volcengine: '火山引擎',
    voiceProvider_cloud_azure: 'Azure 云服务',
    voiceProvider_cloud_custom: '自定义云服务',
    voiceCapabilityReason_available: '可用',
    voiceCapabilityReason_unsupported_platform: '当前平台不支持该 provider。',
    voiceCapabilityReason_provider_not_packaged: '当前安装包未包含该 provider。',
    voiceCapabilityReason_missing_microphone_permission: '需要麦克风权限。',
    voiceCapabilityReason_missing_speech_permission: '需要语音识别权限。',
    voiceCapabilityReason_missing_local_binary: '缺少本地 whisper.cpp 可执行文件。',
    voiceCapabilityReason_missing_local_model: '缺少本地 provider 所需模型文件。',
    voiceCapabilityReason_missing_local_runtime: '缺少本地 provider 所需运行时依赖，例如 Python / qwen-tts / torch。',
    voiceCapabilityReason_disabled_by_config: '当前已被配置关闭。',
    voiceCapabilityReason_provider_config_required: '需要先完成 provider 配置。',
    voiceCapabilityReason_runtime_unavailable: '运行时暂不可用。',
    settingsPanelBasic: '基础',
    settingsPanelRuntime: '运行时',
    settingsPanelParameters: '能力参数',
    voiceOverviewRuntimeStatus: '运行状态',
    voiceOverviewActualEngine: '最近实际播放',
    providerGroup_foundation: '官方内置',
    providerGroup_regional: '区域云平台',
    providerGroup_custom: '自定义',
    providerGroupCountUnit: '个 Provider',
    providerPanel_credentials: '访问凭据',
    providerPanel_endpoint: 'Endpoint / API 格式',
    providerPanel_features: 'Provider 特性',
    providerPanel_connection: '连接测试',
    providerPanel_models: '模型列表',
    providerPanel_advanced: '高级项',
    ttsPlay: '朗读',
    ttsStop: '停止朗读',
    ttsNoSpeakableContent: '当前消息没有可朗读内容',
    coworkTtsUnavailable: '当前环境暂不支持语音朗读',
    coworkSpeechUnavailable: '当前环境暂不支持语音输入',
    coworkSpeechPermissionDenied: '语音识别权限被拒绝，请在系统设置中允许 QingShuClaw 使用语音识别与麦克风。',
    coworkSpeechMicrophonePermissionDenied: '麦克风权限被拒绝，请在系统设置中允许 QingShuClaw 使用麦克风。',
    coworkSpeechRecognizerUnavailable: '当前系统暂时无法使用语音识别，请稍后重试。',
    coworkSpeechDevPermissionPromptUnsupported: '开发环境下的 Electron 宿主无法稳定拉起 macOS 语音识别授权框，请使用打包后的 QingShuClaw.app 验证语音输入权限流程。',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '网易有道 QingShuClaw 服务协议',
    privacyDialogDesc: '在使用网易有道 QingShuClaw 之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: '网易有道 QingShuClaw 服务协议',
  ...
  en: {
    ...
    aboutBrandEyebrow: 'Linggong Daka · Data Agent',
    aboutBrandDescription: 'QingShuClaw runs on top of the QingShu platform and serves as an internal data product that can access and analyze Linggong Daka data within each user\'s permission scope.',
    aboutProductBadge: 'Internal Data Product',
    aboutPlatformBadge: 'QingShu Platform',
    aboutProductType: 'Product',
    aboutProductTypeValue: 'Linggong Daka Data Agent',
    aboutPlatform: 'Platform',
    aboutPlatformValue: 'QingShu Platform',
    aboutDataScope: 'Data Scope',
    aboutDataScopeValue: 'Only accesses Linggong Daka data within the current user\'s permission scope',
    aboutRightsReserved: 'All rights reserved.',
    aboutCopyright: 'Copyright © {year} QingShuClaw',
    testMode: 'Test Mode',
    theme: 'Theme',
    ...
    providerMissingApiKey: 'Missing key',
    providerModelCountUnit: 'models',
    ...
    authLoginPanelTitle: 'Sign in to QingShu',
    ...
    authOpenQtbWeb: 'Open QingShu',
    authOpenQtbWebFailed: 'Failed to open QingShu',
    ...
    authLoginWelcomeSubtitle: 'LINGGONG DAKA',
    authEnterUsernameAndPassword: 'Enter both username and password',
    authSettingsTitle: 'Authentication',
    authSettingsDescription: 'This project now uses QingShu auth by default. Adjust the backend URLs if needed.',
    authBackendQtb: 'QingShu auth (password + Feishu)',
    authQtbApiBaseUrl: 'QingShu API URL',
    authQtbApiBaseUrlPlaceholder: 'For example: http://localhost:9080',
    authQtbWebBaseUrl: 'QingShu Web URL',
    authQtbWebBaseUrlPlaceholder: 'For example: http://localhost:9080/webapp',
    productBrandSignature: 'Linggong Daka QingShu',
    authQuotaExhausted: 'Daily free quota exhausted. Visit QingShuClaw Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    // QingShuClaw
    cowork: 'QingShuClaw',
    coworkSettings: 'QingShuClaw Settings',
    ...
    coworkWorkingDirectoryHint: 'QingShuClaw will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for QingShuClaw...',
    coworkSystemPromptHint: 'Optional system prompt to customize QingShuClaw\'s behavior',
    ...
    coworkModelSettingsHint: 'QingShuClaw uses the current model and provider configuration from Model Settings.',
    ...
    coworkConfigSaveFailed: 'Failed to save QingShuClaw settings. Please try again.',
    ...
    coworkPermissionDescription: 'QingShuClaw is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'QingShuClaw needs your input',
    ...
    coworkSpeechTranscribing: 'Transcribing speech...',
    speechInputCommandsTitle: 'Voice input trigger phrases',
    speechInputCommandsDescription: 'Configure the tail phrases used by macOS local voice input in the chat box to stop recording or stop and submit.',
    speechInputLlmCorrectionLabel: 'Use current model to correct STT results',
    speechInputStopCommandLabel: 'Stop recording phrase',
    speechInputStopCommandPlaceholder: 'For example: stop',
    ...
    coworkSpeechInterrupted: 'Speech recognition was interrupted by the system. Please try again shortly.',
    coworkSpeechNoMatch: 'No transcribable speech was detected.',
    wakeInputTitle: 'Wake voice input',
    wakeInputDescription: 'macOS local only. Listen for wake phrases while the app is in the background, then focus the chat box and start dictation.',
    wakeInputEnabledLabel: 'Enable wake voice input',
    wakeInputWakeWordLabel: 'Fixed wake phrase',
    wakeInputWakeWordsLabel: 'Wake phrase list',
    wakeInputWakeWordsPlaceholder: 'One per line, for example:\nOpen QingShuClaw\nQingshu',
    wakeInputProviderLabel: 'Wake engine',
    wakeInputProvider_text_match: 'macOS native wake',
    wakeInputProvider_sherpa_onnx: 'Sherpa wake',
    wakeInputProviderHint: 'Use macOS native wake by default, or switch to Sherpa if it better matches your habit.',
    wakeInputSherpaModelLabel: 'Sherpa wake model',
    wakeInputSherpaModelHint: 'Sherpa wake defaults to the bilingual `zh-en` model, and can switch back to the older Chinese `WenetSpeech` model.',
    ...
    wakeInputActivationReplyEnabledLabel: 'Voice reply after wake',
    wakeInputActivationReplyTextLabel: 'Wake reply text',
    wakeInputActivationReplyTextPlaceholder: 'For example: I am here',
    ...
    ttsDescription: 'macOS local only. Use macOS local speech synthesis to read assistant replies without any cloud service.',
    ttsEnabledLabel: 'Enable local TTS',
    ttsAutoPlayLabel: 'Auto-play assistant replies',
    ttsLlmRewriteLabel: 'Rewrite narration with the current model before playback',
    ttsSkipKeywordsLabel: 'Skip keywords',
    ttsSkipKeywordsPlaceholder: 'One per line, for example:\n/\nThinking\nTool call',
    ttsSkipKeywordsHint: 'Remove text fragments that should not be spoken. The built-in cleanup still strips emoji, isolated slashes, and markdown noise automatically.',
    ttsEngineLabel: 'TTS engine',
    ttsEngine_macos_native: 'macOS native',
    ttsEngine_edge_tts: 'edge-tts',
    ttsEngine_sherpa_onnx: 'Sherpa-ONNX',
    ttsPrepareStatusLabel: 'Runtime status',
    ttsPrepareStatus_idle: 'Not installed',
    ttsPrepareStatus_installing: 'Installing',
    ttsPrepareStatus_ready: 'Ready',
    ttsPrepareStatus_error: 'Failed',
    ttsPrepareLastErrorLabel: 'Last error',
    ttsActualEngineLabel: 'Last actual playback engine',
    ttsActualEngineNone: 'No playback yet',
    ttsActualEngineFallbackLabel: 'Automatically fell back from the selected engine',
    ttsPrepareRetryButton: 'Reinstall / Retry',
    ...
    voiceSettingsTitle: 'Unified Voice Capabilities',
    voiceSettingsDescription: 'Manage manual dictation, wake input, automatic follow-up dictation, and local playback in one place. The current build includes macOS-native voice paths, local Sherpa-ONNX STT/TTS, and visibility into capability-matrix plus fallback status.',
    desktopAssistantTitle: 'Desktop Assistant (Experimental)',
    desktopAssistantDescription: 'Desktop assistant capabilities are attached as an optional sidecar and stay off by default, so existing voice flows keep their current behavior.',
    desktopAssistantMasterEnabled: 'Enable desktop assistant features',
    desktopAssistantLaunchAtLogin: 'Keep desktop assistant available after launch',
    desktopAssistantAutoOpenPreviewGuide: 'Auto open previewable results',
    desktopAssistantAutoEnterSceneGuide: 'Auto enter guide session',
    desktopAssistantGuideVoiceCommandsEnabled: 'Enable guide voice commands',
    desktopAssistantAssistantReplySpeakMode: 'Guide reply speak mode',
    desktopAssistantAssistantReplySpeakMode_summary: 'Summary',
    desktopAssistantAssistantReplySpeakMode_detailed: 'Detailed',
    desktopAssistantExperimentalHint: 'These toggles currently only persist configuration and do not rewrite manual STT, wake input, follow-up dictation, or TTS behavior.',
    desktopAssistantGuideSessionActive: 'Guide active',
    desktopAssistantGuideSessionIdle: 'Guide idle',
    desktopAssistantGuideReadyLabel: 'Desktop assistant guide',
    desktopAssistantInlineGuideHint: 'This reply contains presentation HTML and will be saved as a local presentation file when the guide starts.',
    desktopAssistantPreviewGuideHint: 'This reply contains a previewable result and can be guided directly.',
    desktopAssistantLocalPreviewLabel: 'Presentation file',
    desktopAssistantOpenLocalPreview: 'Open local presentation file',
    desktopAssistantLinkedPreviewLabel: 'Linked preview',
    desktopAssistantPauseGuide: 'Pause',
    desktopAssistantResumeGuide: 'Resume',
    desktopAssistantPreviousScene: 'Previous',
    desktopAssistantNextScene: 'Next',
    desktopAssistantReplayScene: 'Replay scene',
    desktopAssistantStopGuide: 'Stop',
    desktopAssistantGuideDockTitle: 'Guide controls',
    desktopAssistantGuideProgress: 'Scene {current} / {total}',
    desktopAssistantStartGuide: 'Start guide',
    desktopAssistantAutoSkillHint: 'This request will auto-attach skill: {skill}',
    desktopAssistantAutoSkillBadge: 'Auto',
    desktopAssistantGuideSourceNotFound: 'No recent previewable HTML or page result was found.',
    desktopAssistantState_idle: 'Idle',
    desktopAssistantState_wake_listening: 'Wake listening',
    desktopAssistantState_dictating: 'Dictating',
    desktopAssistantState_assistant_replying: 'Assistant replying',
    desktopAssistantState_assistant_speaking: 'Assistant speaking',
    desktopAssistantState_guide_active: 'Guide active',
    desktopAssistantState_paused: 'Guide paused',
    desktopAssistantState_error: 'Error',
    voiceCapabilityManualSttTitle: 'Manual voice input',
    voiceManualSttDescription: 'Controls whether the chat-box microphone button is available.',
    voiceCapabilityWakeInputTitle: 'Wake input',
    voiceCapabilityFollowUpTitle: 'Automatic follow-up dictation',
    followUpDictationDescription: 'When enabled, this applies to the current active session. Voice input will restart after the reply finishes, even if the previous turn was not started by voice.',
    voiceCapabilityTtsTitle: 'Speech playback',
    voiceProviderStatusTitle: 'Provider Status',
    voiceProviderStatusDescription: 'Platform support, packaged provider availability, and current runtime/config readiness all come from this capability matrix.',
    voiceShowAllStatuses: 'Show all statuses',
    voiceShowInUseStatuses: 'Show in-use only',
    voiceRoutingTitle: 'Provider Routing',
    voiceRoutingDescription: 'Choose providers for manual dictation and speech playback, and define the fallback strategy when the preferred provider is unavailable.',
    voiceStrategyLabel: 'Fallback strategy',
    voiceStrategy_manual: 'Selected provider only',
    voiceStrategy_native_first: 'Native first',
    voiceStrategy_cloud_first: 'Cloud first',
    voiceManualSttProviderLabel: 'Manual dictation provider',
    voiceTtsProviderLabel: 'Speech playback provider',
    voiceFollowUpProviderHint: 'Automatic follow-up dictation reuses the manual dictation provider resolution and is not configured separately. If the current build does not include a cloud provider, the capability matrix will show the exact reason.',
    voiceCloudProviderConfigTitle: 'Voice Provider Configuration',
    voiceCloudProviderConfigDescription: 'Manage local and cloud voice provider settings in one place. OpenAI, Aliyun, and Volcengine STT/TTS are wired up, Azure TTS is available, and local `whisper.cpp` already has a minimal execution path plus local-asset governance entry points.',
    voiceProviderWorkspaceTitle: 'Voice provider workspace',
    voiceProviderWorkspaceDescription: 'Keep provider summaries on the left and edit only the selected provider on the right so the page no longer expands every provider at once.',
    voiceProviderWorkspaceExpand: 'Expand workspace',
    voiceProviderWorkspaceCollapse: 'Collapse workspace',
    voiceProviderWorkspaceSelectedLabel: 'Current editor',
    voiceProviderWorkspaceRoutesLabel: 'Linked capabilities',
    voiceProviderWorkspaceInUseCountLabel: 'In use',
    voiceProviderWorkspaceInUseCountValue: '{count} providers',
    voiceProviderConfigured: 'Configured',
    voiceProviderNotConfigured: 'Not configured',
    voiceProviderInUse: 'In use',
    voiceProviderSelectHint: 'Select a provider from the left to inspect or adjust its runtime settings.',
    voiceProviderLinkedCapabilitiesLabel: 'Linked capabilities',
    voiceProviderManagedInTtsHint: 'Voice, rate, and volume for this provider are managed in the TTS capability panel above.',
    voiceOverviewRequestedProvider: 'Requested provider',
    voiceOverviewActualProvider: 'Actual provider',
    voiceOverviewFallbackStatus: 'Fallback status',
    voiceOverviewFallbackReason: 'Fallback reason',
    voiceFallbackActive: 'Fallback active',
    voiceFallbackInactive: 'No fallback',
    voiceLocalWhisperCppDescription: 'Configuration for the local `whisper.cpp` STT provider. Manual dictation, follow-up dictation, capability-matrix checks, package differentiation, and local asset troubleshooting are all wired up.',
    voiceLocalSherpaOnnxDescription: 'Configuration for the local `Sherpa-ONNX` STT provider. It is intended for offline Chinese dictation, with macOS-native dictation fallback when available.',
    voiceLocalQwen3TtsDescription: 'Configuration for the local `Qwen3-TTS` provider. It supports on-demand model downloads, Python runtime checks, and an experimental local synthesis path.',
    voiceCloudOpenAiDescription: 'OpenAI cloud voice configuration. Manual STT, follow-up dictation STT, and TTS are all wired up.',
    voiceCloudAliyunDescription: 'Aliyun DashScope / Model Studio voice configuration. Manual STT, follow-up dictation STT, and TTS are all wired up.',
    voiceCloudVolcengineDescription: 'Volcengine audio-tech / Doubao Voice configuration. Manual STT, follow-up dictation STT, and TTS are all wired up.',
    voiceCloudAzureDescription: 'Azure Speech TTS configuration. TTS is wired up now, and STT can be added here later.',
    voiceCloudCustomDescription: 'Reserved configuration for custom cloud STT/TTS endpoints.',
    voiceProviderApiKeyLabel: 'API key',
    voiceProviderBaseUrlLabel: 'Base URL',
    voiceProviderBinaryPathLabel: 'Binary path',
    voiceProviderModelPathLabel: 'Model path',
    ...
    voiceProviderModelIdLabel: 'Model ID',
    voiceProviderModelNameLabel: 'Model name',
    voiceProviderSttModelLabel: 'STT model',
    voiceProviderTtsModelLabel: 'TTS model',
    voiceProviderTtsVoiceLabel: 'TTS voice',
    voiceProviderSherpaAsrModelIdLabel: 'Sherpa ASR model ID',
    voiceProviderSherpaTtsModelIdLabel: 'Sherpa TTS model ID',
    voiceProviderSherpaAsrModelPathLabel: 'Sherpa ASR model path',
    voiceProviderSherpaTtsModelPathLabel: 'Sherpa TTS model path',
    voiceProviderSherpaProviderLabel: 'Sherpa runtime provider',
    voiceProviderSherpaSampleRateLabel: 'Sherpa sample rate',
    voiceSherpaWakeModelLabel: 'Sherpa wake model',
    voiceSherpaResourceRootLabel: 'Sherpa resource root',
    voiceSherpaAsrReadyLabel: 'Sherpa ASR ready',
    voiceSherpaWakeReadyLabel: 'Sherpa wake ready',
    voiceSherpaTtsReadyLabel: 'Sherpa TTS ready',
    voiceSherpaResolvedAsrModelLabel: 'Sherpa ASR model path',
    voiceSherpaResolvedTtsModelLabel: 'Sherpa TTS model path',
    voiceSherpaWakeResourceRootLabel: 'Sherpa wake resource root',
    voiceSherpaVoiceCountLabel: 'Sherpa voice count',
    voiceSherpaFallbackPolicyLabel: 'macOS fallback policy',
    sherpaWakeModel_zh_en: 'zh-en-3M-2025-12-20 (Chinese + English)',
    sherpaWakeModel_wenetspeech: 'wenetspeech-3.3M-2024-01-01 (Chinese)',
    voiceSherpaFallbackPolicyMacos: 'Prefer Sherpa and fall back to macOS native automatically on failure.',
    voiceSherpaFallbackPolicyNone: 'No macOS-native fallback is available on this platform.',
    voiceProviderSpeakerLabel: 'Speaker',
    voiceProviderInstructLabel: 'Style prompt',
    voiceProviderDeviceLabel: 'Device',
    voiceProviderLocalTaskLabel: 'Local task mode',
    voiceProviderLocaleLabel: 'Locale',
    voiceProviderThreadsLabel: 'Threads',
    voiceProviderUseGpuLabel: 'Use GPU',
    voiceProviderAutoDownloadModelLabel: 'Auto-download model',
    voiceLocalWhisperCppEnabledLabel: 'Provider enabled',
    voiceLocalWhisperCppReadyLabel: 'Local assets ready',
    voiceLocalWhisperCppBinaryExistsLabel: 'Binary exists',
    voiceLocalWhisperCppModelExistsLabel: 'Model exists',
    voiceLocalWhisperCppResourceRootLabel: 'Resource root',
    voiceLocalWhisperCppBinaryDirectoryLabel: 'Binary directory',
    voiceLocalWhisperCppModelsDirectoryLabel: 'Models directory',
    voiceLocalWhisperCppExpectedBinaryLabel: 'Default binary path',
    voiceLocalWhisperCppExpectedModelLabel: 'Default model path',
    voiceLocalWhisperCppResolvedBinaryLabel: 'Resolved binary path',
    voiceLocalWhisperCppResolvedModelLabel: 'Resolved model path',
    voiceLocalWhisperCppRefreshButton: 'Refresh status',
    voiceLocalWhisperCppPrepareButton: 'Create resource dirs',
    voiceLocalWhisperCppOpenRootButton: 'Open resource dir',
    voiceLocalWhisperCppOpenModelsButton: 'Open models dir',
    voiceLocalWhisperCppRefreshSuccess: 'Local whisper.cpp status has been refreshed.',
    voiceLocalWhisperCppPrepareSuccess: 'Local whisper.cpp resource directories have been created.',
    voiceLocalWhisperCppPrepareFailed: 'Failed to prepare local whisper.cpp resource directories.',
    voiceLocalWhisperCppDirectoryUnavailable: 'The local whisper.cpp directory is currently unavailable.',
    voiceLocalQwen3TtsEnabledLabel: 'Provider enabled',
    voiceLocalQwen3TtsReadyLabel: 'Local runtime ready',
    voiceLocalQwen3TtsPythonAvailableLabel: 'Python available',
    voiceLocalQwen3TtsPythonResolvedPathLabel: 'Resolved Python path',
    voiceLocalQwen3TtsPythonVersionLabel: 'Python version',
    voiceLocalQwen3TtsModelExistsLabel: 'Model exists',
    voiceLocalQwen3TtsTokenizerExistsLabel: 'Tokenizer exists',
    voiceLocalQwen3TtsQwenModuleLabel: '`qwen_tts` module available',
    voiceLocalQwen3TtsTorchModuleLabel: '`torch` module available',
    voiceLocalQwen3TtsSoundfileModuleLabel: '`soundfile` module available',
    voiceLocalQwen3TtsHuggingfaceCliLabel: '`huggingface-cli` available',
    voiceLocalQwen3TtsHuggingfaceHubLabel: '`huggingface_hub` module available',
    voiceLocalQwen3TtsRunnerWritableLabel: 'Runtime directory writable',
    voiceLocalQwen3TtsRuntimeIssuesLabel: 'Runtime issues',
    voiceLocalQwen3TtsModelsRootLabel: 'Models root',
    voiceLocalQwen3TtsExpectedModelLabel: 'Default model path',
    voiceLocalQwen3TtsExpectedTokenizerLabel: 'Default tokenizer path',
    voiceLocalQwen3TtsResolvedModelLabel: 'Resolved model path',
    voiceLocalQwen3TtsResolvedTokenizerLabel: 'Resolved tokenizer path',
    voiceLocalQwen3TtsRefreshButton: 'Refresh local TTS status',
    voiceLocalQwen3TtsOpenRootButton: 'Open local voice root',
    voiceLocalQwen3TtsOpenModelsButton: 'Open Qwen3-TTS models dir',
    voiceLocalQwen3TtsRefreshSuccess: 'Local Qwen3-TTS status has been refreshed.',
    voiceLocalQwen3TtsDirectoryUnavailable: 'The local Qwen3-TTS directory is currently unavailable.',
    voiceLocalQwen3TtsTask_custom_voice: 'Custom Voice',
    voiceLocalQwen3TtsTask_voice_design: 'Voice Design',
    voiceLocalQwen3TtsNoRuntimeIssues: 'No additional runtime issues were detected',
    voiceLocalModelRecommendedTag: 'Recommended',
    voiceLocalModelSizeLabel: 'Model size',
    voiceLocalModelInstallBackendLabel: 'Install backend',
    voiceLocalModelStatusLabel: 'Install status',
    voiceLocalModelProgressLabel: 'Download progress',
    voiceLocalModelLastErrorLabel: 'Last error',
    voiceLocalModelInstallButton: 'Download',
    voiceLocalModelReinstallButton: 'Re-download',
    voiceLocalModelCancelButton: 'Cancel',
    voiceLocalModelOpenPathButton: 'Open path',
    voiceLocalModelUseButton: 'Use this model',
    voiceLocalModelInUseTag: 'In use',
    voiceLocalModelRequirementsLabel: 'Host requirements',
    voiceLocalModelWarningsLabel: 'Important warnings',
    voiceLocalModelInstallConfirmTitle: 'Please confirm the host requirements before downloading the local voice model.',
    voiceLocalModelInstallFailed: 'Failed to download the local voice model.',
    voiceLocalModelOpenPathFailed: 'Failed to open the local voice model path.',
    voiceLocalModelBackend_direct: 'Direct download',
    voiceLocalModelBackend_direct_archive: 'Download and extract',
    voiceLocalModelBackend_huggingface_cli: 'Hugging Face CLI',
    voiceLocalModelBackend_modelscope_cli: 'ModelScope CLI',
    voiceLocalModelState_not_installed: 'Not installed',
    voiceLocalModelState_downloading: 'Downloading',
    voiceLocalModelState_installed: 'Installed',
    voiceLocalModelState_error: 'Install error',
    voiceProviderVolcengineAppKeyLabel: 'Volcengine AppKey',
    voiceProviderVolcengineTokenLabel: 'Volcengine token',
    voiceProviderAzureRegionLabel: 'Azure region',
    voiceProviderAzureEndpointLabel: 'Azure endpoint',
    voiceProviderCustomSttPathLabel: 'STT path',
    voiceProviderCustomTtsPathLabel: 'TTS path',
    voiceCurrentProviderLabel: 'Current provider',
    voicePlatformSupportLabel: 'Platform support',
    voicePackagedSupportLabel: 'Packaged support',
    voiceRuntimeAvailableLabel: 'Runtime available',
    voiceConfiguredLabel: 'Configured',
    voiceReasonLabel: 'Status detail',
    voiceAvailabilityYes: 'Yes',
    voiceAvailabilityNo: 'No',
    voiceProvider_none: 'Not selected',
    voiceProvider_macos_native: 'macOS native',
    voiceProvider_local_sherpa_onnx: 'Local Sherpa-ONNX',
    voiceProvider_local_whisper_cpp: 'Local whisper.cpp',
    voiceProvider_local_qwen3_tts: 'Local Qwen3-TTS',
    voiceProvider_cloud_openai: 'OpenAI cloud',
    voiceProvider_cloud_aliyun: 'Aliyun',
    voiceProvider_cloud_volcengine: 'Volcengine',
    voiceProvider_cloud_azure: 'Azure cloud',
    voiceProvider_cloud_custom: 'Custom cloud',
    voiceCapabilityReason_available: 'Available',
    voiceCapabilityReason_unsupported_platform: 'This provider is not supported on the current platform.',
    voiceCapabilityReason_provider_not_packaged: 'This provider is not included in the current build.',
    voiceCapabilityReason_missing_microphone_permission: 'Microphone permission is required.',
    voiceCapabilityReason_missing_speech_permission: 'Speech recognition permission is required.',
    voiceCapabilityReason_missing_local_binary: 'The local whisper.cpp executable is missing.',
    voiceCapabilityReason_missing_local_model: 'The required local model files are missing for this provider.',
    voiceCapabilityReason_missing_local_runtime: 'Required local runtime dependencies such as Python / qwen-tts / torch are missing.',
    voiceCapabilityReason_disabled_by_config: 'This capability is disabled by configuration.',
    voiceCapabilityReason_provider_config_required: 'Provider configuration is required.',
    voiceCapabilityReason_runtime_unavailable: 'The provider is currently unavailable at runtime.',
    settingsPanelBasic: 'Basics',
    settingsPanelRuntime: 'Runtime',
    settingsPanelParameters: 'Capability parameters',
    voiceOverviewRuntimeStatus: 'Runtime status',
    voiceOverviewActualEngine: 'Last actual playback',
    providerGroup_foundation: 'Built-in',
    providerGroup_regional: 'Regional cloud',
    providerGroup_custom: 'Custom',
    providerGroupCountUnit: 'providers',
    providerPanel_credentials: 'Credentials',
    providerPanel_endpoint: 'Endpoint / API format',
    providerPanel_features: 'Provider features',
    providerPanel_connection: 'Connection test',
    providerPanel_models: 'Models',
    providerPanel_advanced: 'Advanced',
    ttsPlay: 'Play',
    ttsStop: 'Stop',
    ttsNoSpeakableContent: 'This message does not contain readable content.',
    coworkTtsUnavailable: 'Speech playback is unavailable in the current environment.',
    coworkSpeechUnavailable: 'Voice input is unavailable in the current environment.',
    coworkSpeechPermissionDenied: 'Speech recognition permission was denied. Please allow QingShuClaw to access speech recognition and the microphone in System Settings.',
    coworkSpeechMicrophonePermissionDenied: 'Microphone permission was denied. Please allow QingShuClaw to access the microphone in System Settings.',
    coworkSpeechRecognizerUnavailable: 'Speech recognition is currently unavailable on this system. Please try again later.',
    coworkSpeechDevPermissionPromptUnsupported: 'The Electron development host cannot reliably trigger the macOS speech permission prompt. Please verify the voice-input permission flow with the packaged QingShuClaw.app.',
    ...
    // Privacy dialog
    privacyDialogTitle: 'NetEase Youdao QingShuClaw Terms of Service',
    privacyDialogDesc: 'Before using NetEase Youdao QingShuClaw, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'NetEase Youdao QingShuClaw Terms of Service',
