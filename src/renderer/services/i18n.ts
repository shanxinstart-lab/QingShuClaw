...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    voiceSettingsDescription: '统一管理手动语音输入、语音唤醒、自动续麦和本地语音朗读。当前本地实现来源均为 macOS 原生能力。',
  ...
  en: {
    ...
    voiceSettingsDescription: 'Manage manual dictation, wake input, automatic follow-up dictation, and local playback in one place. The current local implementation is powered by macOS native capabilities.',
