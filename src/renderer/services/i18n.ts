...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkAgentEngineClaudeLegacy: 'Cowork（默认）',
    ...
    coworkOpenClawInstall: '下载安装 OpenClaw',
    coworkOpenClawRetryInstall: '重试安装 OpenClaw',
    coworkOpenClawStart: '启动 OpenClaw',
    coworkOpenClawRunning: 'OpenClaw 已运行',
    coworkOpenClawInstalling: '正在下载安装 OpenClaw...',
    coworkOpenClawInstallHint: '仅在你点击按钮后才会下载安装并启动 OpenClaw。',
    coworkOpenClawGoToSettingsInstall: '前往设置安装',
    coworkOpenClawNotInstalledNotice: 'OpenClaw 尚未安装，请前往设置页手动下载安装。',
    coworkOpenClawReadyNotice: 'OpenClaw 已安装。开始任务时会自动启动网关。',
  ...
  en: {
    ...
    coworkAgentEngineClaudeLegacy: 'Cowork (Default)',
    ...
    coworkOpenClawInstall: 'Install OpenClaw',
    coworkOpenClawRetryInstall: 'Retry OpenClaw Install',
    coworkOpenClawStart: 'Start OpenClaw',
    coworkOpenClawRunning: 'OpenClaw Running',
    coworkOpenClawInstalling: 'Installing OpenClaw...',
    coworkOpenClawInstallHint: 'OpenClaw will be downloaded, installed, and started only after you click the button.',
    coworkOpenClawGoToSettingsInstall: 'Go to Settings to Install',
    coworkOpenClawNotInstalledNotice: 'OpenClaw is not installed. Please install it from Settings.',
    coworkOpenClawReadyNotice: 'OpenClaw is installed. The gateway will auto-start when you run a task.',
