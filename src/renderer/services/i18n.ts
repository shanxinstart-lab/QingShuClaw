...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksFormAgentIdPlaceholder: '可选，留空使用主助理',
  ...
  en: {
    ...
    myAgents: 'My Agents',
    defaultAgentDisplayName: 'Primary Assistant',
    ...
    imAgentBindingDefault: 'Default (Primary Assistant)',
    imAgentBindingHint:
    ...
    scheduledTasksFormAgentId: 'Agent ID',
    scheduledTasksFormAgentIdPlaceholder: 'Optional, leave blank to use Primary Assistant',
