        ...
        <div className="space-y-3 pt-2">
          ...
          <div>
            ...
            <input
              ...
              onChange={(event) => onEmbeddingRemoteBaseUrlChange(event.target.value)}
          ...
          <div>
            ...
            <input
              ...
              onChange={(event) => onEmbeddingRemoteApiKeyChange(event.target.value)}
              className="w-full rounded-lg border px-3 py-2 text-sm border-border bg-surface font-mono"
            />
            <div className="text-xs text-secondary mt-1">
          ...
          {showAdvanced && (
            <div>
              ...
              <input
                ...
                onChange={(event) => onEmbeddingVectorWeightChange(Number(event.target.value))}
                className="w-full"
              />
              <div className="text-xs text-secondary mt-1">
